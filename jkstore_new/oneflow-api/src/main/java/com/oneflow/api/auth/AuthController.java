...
public class AuthController {
    ...
    public ApiResponse<String> publicKey() {
        return ApiResponse.legacy(0, "spring-boot-migration-public-key-placeholder");
    }
    ...
    public ApiResponse<Object> login(@RequestBody(required = false) LoginRequest request) {
        ...
        // encryptedPassword 后续会接入 RSA/OAEP 解密，完全对齐旧 backend/crypto/rsa.js。
        String password = StringUtils.hasText(request.getPassword()) ? request.getPassword() : request.getEncryptedPassword();
